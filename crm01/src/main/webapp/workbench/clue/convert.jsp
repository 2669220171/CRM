...
<script type="text/javascript" src="jquery/bootstrap-datetimepicker-master/locale/bootstrap-datetimepicker.zh-CN.js"></script>
	...
	$(function(){
		...
		//
		$("#opeanSearchModalBtn").click(function () {
		...
		$("#convertBtn").click(function () {
			...
			if ($("#isCreateTransaction").prop("checked")){
				//alert("需要创建交易");
				//window.location.href = "workbench/clue/conver.do?clueId=${param.id}";
				$("#tranForm").submit();
...
<body>
	...
	<div id="create-transaction2" style="position: relative; left: 40px; top: 20px; width: 80%; background-color: #F7F7F7; display: none;" >
		...
		<form id="tranForm" action="workbench/clue/convert.do" method="post">
		  ...
		  <div class="form-group" style="width: 400px;position: relative; left: 20px;">
		    <label for="activityName">市场活动源&nbsp;&nbsp;<a href="javascript:void(0);" id="opeanSearchModalBtn" style="text-decoration: none;"><span class="glyphicon glyphicon-search"></span></a></label>
